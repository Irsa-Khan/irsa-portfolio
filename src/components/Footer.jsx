...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-gray-300 py-12 px-6 sm:px-10 md:px-16">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm md:text-base leading-relaxed">
            ...
            Tailwind CSS, and MongoDB. I’ve built projects like a real-time chat
            app, interactive dashboard, and eCommerce site — creating responsive
        ...
        <div>
          ...
          <form className="flex flex-col sm:flex-row md:flex-col gap-3">
            <input
              ...
              className="italic flex-1 bg-gray-800 text-gray-300 text-sm px-4 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-500"
            />
            <button
              type="submit"
              className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white text-sm py-2 px-6 rounded-full shadow-md transition duration-300 ease-in-out w-full sm:w-auto md:w-40"
            >
              Subscribe
            </button>
          </form>
      ...
      {/* Copyright */}
      <div className="text-center text-gray-500 text-xs md:text-sm mt-8">
